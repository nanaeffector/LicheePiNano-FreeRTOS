...
{
	uint32_t * ttb = (uint32_t *)(0x80000000 + 0x00100000 * 31);

	map_l1_section(ttb, 0x00000000, 0x00000000, 0x80000000, 0);
	map_l1_section(ttb, 0x80000000, 0x80000000, 0x80000000, 0);
	map_l1_section(ttb, 0x80000000, 0x80000000, 0x00100000 * 32, 3);
